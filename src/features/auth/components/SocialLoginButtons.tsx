  ...
  return (
    <div className="space-y-3">
      ...
      >
        ...
        <span className="text-sm font-medium text-neutral-950">Continue with Google</span>
      </button>
      ...
      >
        ...
        <span className="text-sm font-medium text-neutral-950">Continue with Apple</span>
      </button>
    </div>
  );
};
